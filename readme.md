...
此存储库包含 Microsoft 课程 [DA-100：使用 Power BI 分析数据](https://docs.microsoft.com/zh-cn/learn/certifications/courses/da-100t00)的动手实验室练习。这些实验室专门设计为配合教材使用，可以让学员使用其描述的方法进行练习。
